...
Five small Lean 4 examples that type-check under the project runner — with one intentional `sorry` warning. One shows what verification genuinely closes; the other four each sit on top of the shape of a real bug. They accompany the essay [`ARTICLE.md`](./ARTICLE.md).
